...
@Autonomous(name = "Highgoal", group = "autonomous")
public class Highgoal_UG extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            GyroTurn(-10, 0.3);
            AttachmentsControl(AttachmentStates.STARTSHOOTER, 0.63);
            ...
            AttachmentsControl(AttachmentStates.STOPINTAKE, 0);
