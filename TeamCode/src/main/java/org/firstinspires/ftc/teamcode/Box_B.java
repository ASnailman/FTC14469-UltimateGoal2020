...
@Autonomous(name = "IAutoWinEverytime", group = "autonomous")
public class Box_B extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //back up to rings
            GyroTurn(-15, 0.9);
            DirectionFollower(-2300, 0.9, -10, 0.0003, 0.000001, 0.03);
            //pick up rings and face high goal
            AttachmentsControl(AttachmentStates.STARTINTAKE);
            GyroTurn(0, 0.9);
            DirectionFollower(700, 0.9, 0, 0.0003, 0.000001, 0.03);
            //shoot ring
