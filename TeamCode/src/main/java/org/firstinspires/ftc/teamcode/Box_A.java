...
@Autonomous(name = "AutoVictory", group = "autonomous")
public class Box_A extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //face box a
            GyroTurn(40, 0.9);
            DirectionFollower(2500, 0.9, 40, 0.0003, 0.000001, 0.03);
            //place wobble goal in box a
            ArmTurn(0.8, 1200);
            sleep(200);
            ArmClawPosition(0.6, 600);
            ArmTurn(-0.8, 100);
            //back up; turn towards right red line
            DirectionFollower(-4990, 0.9, 40, 0.0003, 0.000001, 0.03);
            GyroTurn(90.15, 0.9);
               //ArmTurn(0.8, 90);
            //move towards second wobble goal
            DirectionFollower(1575, 0.5, 90, 0.0003, 0.000001, 0.03);
           //pick up wobble goal
            ArmClawPosition(-0.6, 600);
            hexjerry.setPower(1);
            ArmTurn(-0.8, 700);
            DirectionFollower(1000, 0.9, 90, 0.0003, 0.000001, 0.03);
            //turn to face box a
            GyroTurn(0, 0.9);
            //place second wobble goal in box a and park on line
            //DirectionFollower(4500, 0.9, 0, 0.0003, 0.000001, 0.03);
            WhiteDirectionFollower(0.9, 0, 0.0003, 0.000001, 0.03);
            ArmTurn(0.8, 1000);
            ArmClawPosition(0.6, 500);
