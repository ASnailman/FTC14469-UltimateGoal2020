...
@Autonomous(name = "HighGoal_Final", group = "autonomous")
public class Highgoal_UG_Final extends LinearOpMode {
    ...
    private static final int SHOOTER_ANGULAR_SPEED_MAX = 1670;
    private static final int SHOOTER_ANGULAR_SPEED_RANGE = 70;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (Box_A) {
                ...
                ArmTurn_RTP(-2900);
                DirectionFollower(1930, 1, 70, 0.0003, 0.000001, 0.03);
                sleep(300);
                ...
                GyroTurn(90, 1);
                DirectionFollower(2250, 0.7, 90, 0.0003, 0.000001, 0.03);
                ...
                DirectionFollower(3800, 1, 22, 0.0003, 0.000001, 0.03);
                ...
                //"Close" the gate to prevent any accidental shooting
                ...
                GyroTurn2(-6, 0.9, true, true);
                DirectionFollower2(800, 1, -6, 0.0003, 0.000001, 0.03);
                SetMotorPower(0);
                sleep(200);
                ...
                ArmTurn_RTP(-3100);
                DirectionFollower2(950, 1, -8, 0.0003, 0.000001, 0.03);
                SetMotorPower(0);
                sleep(600);
                ArmClawPosition(1, 200);
                ArmTurn_RTP(-800);
                ...
                DirectionFollower2(-4400, 1, -2, 0.0003, 0.000001, 0.03);
                DirectionFollower2(-300, .6, -2, 0.0003, 0.000001, 0.03);
                DirectionFollower2(-200, 0.3, -2, 0.0003, 0.000001, 0.03);
                DirectionFollower2(-1310, 0.7, -2, 0.0003, 0.000001, 0.03);
                ...
                //AttachmentsControl(AttachmentStates.LAUNCHPREP, SHOOTER_TARGET_SPEED, 0);
                AttachmentsControl(AttachmentStates.STOPINTAKE, SHOOTER_TARGET_SPEED, 0);
                ...
                GyroTurn2(-5, 0.9, true, true);
                //AttachmentsControl(AttachmentStates.STOPINTAKE, SHOOTER_TARGET_SPEED, 0);

                //move forward to shoot the rings into the high goal
                DirectionFollower2(2350, 1, -6, 0.0003, 0.000001, 0.03);
                sleep(200);
                ...
                DirectionFollower2(-1250,1, 14, 0.0003, 0.000001, 0.03);
