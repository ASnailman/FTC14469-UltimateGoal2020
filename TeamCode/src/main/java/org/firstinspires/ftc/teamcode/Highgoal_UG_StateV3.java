...
@Autonomous(name = "HighGoal_StateV3", group = "autonomous")
public class Highgoal_UG_StateV3 extends LinearOpMode {
    ...
    private static final int SHOOTER_ANGULAR_SPEED_MAX = 1550;
    private static final int SHOOTER_ANGULAR_SPEED_RANGE = 60;
    private static final double SHOOTER_TARGET_SPEED = 0.65;
    ...
    public void runOpMode() {
        ...
        shooterjerry.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        while (opModeIsActive()) {
            ...
            if (Box_A) {
                ...
                ArmTurn_RTP(-3100);
                DirectionFollower(-2650, 0.75, 40, 0.0003, 0.00001, 0.05);
                ...
                DirectionFollower(1700, 0.75, 22, 0.0003, 0.00001, 0.05);
                ...
                //Close the gate to prevent an accidental launch
                servojerry.setPosition(1);
                ...
                //back up and pick up rings; raise arm up a bit so it won't hit the wall when it turns later
                AttachmentsControl(AttachmentStates.STARTINTAKE, SHOOTER_TARGET_SPEED, 0);
                GyroTurn2(-23, 0.7, true, true);
                ArmTurn_RTP(-2700);
                DirectionFollower2(-2200, 0.5, -23, 0.0003, 0.00001, 0.05);
                ...
                hexjerry.setPower(-1);
                ArmTurn_RTP(-1100);
                AttachmentsControl(AttachmentStates.STOPINTAKE, SHOOTER_TARGET_SPEED, 0);
                ...
                DirectionFollower2(100, 0.6, -6, 0.0003, 0.00001, 0.05);
                sleep(200);
                ...
                ArmTurn_RTP(-3100);
                DirectionFollower2(400, 0.6, -6, 0.0003, 0.00001, 0.05);
                //GyroTurn2(0, 0.6, false, true);
                sleep(600);
                ArmClawPosition(1, 200);
                ArmTurn_RTP(-100);
                ...
                //start the intake and reverse
                DirectionFollower2(-300, 0.7, 45, 0.0003, 0.00001, 0.05);
                ArmTurn_RTP(-2700);
                GyroTurn2(-5, 0.8, true, true);

                //reverse but slow down when hitting the stack of rings so it doesn't scatter far
                //DirectionFollower(-7100, 0.8, -6, 0.0003, 0.000001, 0.03);
                DirectionFollower2(-2200, 0.73, -5, 0.0003, 0.00001, 0.05);
                AttachmentsControl(AttachmentStates.STARTINTAKE, SHOOTER_TARGET_SPEED, 0);
                sleep(500);
                //DirectionFollower2(-200, 0.4, -5, 0.0003, 0.00001, 0.05);
                //DirectionFollower2(-150, 0.3, -5, 0.0003, 0.00001, 0.05);
                DirectionFollower2(-750, 0.7, -5, 0.0003, 0.00001, 0.05);
                sleep(200);

                //Turn towards 2nd wobble goal
                ArmTurn_RTP(-3150);
                GyroTurn2(139, 0.8, false, true);
                sleep(200);
                //AttachmentsControl(AttachmentStates.STOPINTAKE, SHOOTER_TARGET_SPEED, 0);
                intakejerry.setPower(0);
                ArmClawPosition(-.8, 200);
                hexjerry.setPower(-1);
                ArmTurn_RTP(-1000);
                sleep(200);
                ...
                DirectionFollower2(1000, 0.7, -5, 0.0003, 0.00001, 0.05);
                AttachmentsControl(AttachmentStates.STOPINTAKE, SHOOTER_TARGET_SPEED, 0);
                ...
                DirectionFollower2(-2000, 0.7,-5, 0.0003, 0.00001, 0.05);
                //sleep(200);
                DirectionFollower2(2000, 0.7,-5, 0.0003, 0.00001, 0.05);
