...
@Autonomous(name = "boxC", group = "autonomous")
public class boxC extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            //mainly guessing at this point for box c
            AttachmentsControl(AttachmentStates.STARTINTAKE);
            DirectionFollower(3700, 0.8, 0, 0.0003, 0.000001, 0.03);
            GyroTurn(43, 0.8);
            DirectionFollower(1821, 0.8, 45, 0.0003, 0.000001, 0.03);
            ArmTurn(0.8, 700);
            sleep(200);
            ArmClawPosition(0.8, 500);
            ArmTurn(-0.8, 300);
            //pick up rings
            GyroTurn(0,0.6);
            DirectionFollower(-6000, 0.9, 0, 0.0003, 0.000001, 0.03);
            GyroTurn(-22, 0.8);
            DirectionFollower(-600,0.9,0,0.0003, 0.000001, 0.03);
            AttachmentsControl(AttachmentStates.STOPINTAKE,0.7);
            AttachmentsControl(AttachmentStates.STARTSHOOTER,0.7);
            DirectionFollower(800, 0.8, 0, 0.0003, 0.000001, 0.03);
            SetMotorPower(0);
            sleep(400);
            //shoot
            GyroTurn(-10,0.6);
            AttachmentsControl(AttachmentStates.STARTINTAKE);
            AttachmentsControl(AttachmentStates.LAUNCH,0.7);
            AttachmentsControl(AttachmentStates.LAUNCH,0.7);
            AttachmentsControl(AttachmentStates.LAUNCH, 0.7);
            DirectionFollower(1200,0.8, 0, 0.0003, 0.000001, 0.03);
    ...
    private void MoveEncoder(double TargetPosition, double Power) {
        ...
        if (TargetPosition > 0) {
            ...
            while (frontright.getCurrentPosition() < TargetPosition) {
                ...
                telemetry.addData("Right Motor", frontright.getCurrentPosition());
                telemetry.update();
    ...
    private void DistanceFollower (double power, double TargetDirection,
                                   double kp_in, double ki_in, double kd_in) {
